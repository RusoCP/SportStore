import { AfterViewInit, Component, DoCheck, IterableDiffer, IterableDiffers, ViewChild } from "@angular/core";
...
export class ProductTableComponent implements AfterViewInit, DoCheck {
